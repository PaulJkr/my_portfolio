...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: "Evolve Emergency Global Trainers",
      description:
        "A global training platform focused on life-saving emergency care courses — offering BLS, ACLS, Heartsaver, and first-aid training for healthcare professionals and community responders. The platform prioritizes accessible, high-quality certification and international impact.",
      technologies: ["React", "TypeScript", "Tailwind CSS"],
      features: [
        "Inventory management systemCourse catalog (BLS, ACLS, Heartsaver, First Aid)",
        "Schedule viewing and enrollment",
        "Global reach / impact metrics (certified trainees, countries reached)",
